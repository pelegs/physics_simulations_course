...
Local (truncation) error: $\bigO{\Delta t^{2}}$. Global error: if reduce $\Delta t$ by $\alpha$, we would need $\alpha$ times the amount of steps, hence the global error is $\bigO{\Delta t}$.
