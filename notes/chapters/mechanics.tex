...
\begin{figure}
  \begin{center}
    ...
    \begin{axis}[
      ...
      \foreach \E in {0.0,0.2,...,1.0,1.5,...,4.0} { 
        \edef\drawconic{\noexpand\addplot+[very thick, data cs=polar, domain=0:2*pi, samples=100, smooth, ] (x,{\A*(\E+\A)/(1+\E*cos(x))}) node[pos=0.75, above] {$e=\E$};}
          \drawconic
        }
...
\begin{figure}
  \begin{center}
    \begin{tikzpicture}
      ...
      % Drawings
      \draw[ultra thick, black!75] (0,0) ellipse [x radius=\a, y radius=\b];
