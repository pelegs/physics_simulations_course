...
In the case where we only consider two objects, and choose our frame of reference such that one of the objects is stationary - an analytical solution to the spatial trajectory taken by the second object is known and well studied. It always takes the form of a conic section.

\subsection{Conic Sections}
A conic section (sometimes simply just called \enquote{a conic}) is the 2-dimensional intersection of a plane and a cone (see \autoref{fig:3d_conic_1}).

\begin{figure}
  \begin{center}
    \includegraphics[scale=0.875]{figs/cone_plane_3d.pdf}
  \end{center}
