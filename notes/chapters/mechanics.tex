...
Test:
\begin{align}
	\ddot{\theta}_{1} = - \frac{L_{2} \dot{\theta}_{2}^{2} m_{2} \sin{\left(\theta_{1} - \theta_{2} \right)} + L_{2} m _{2} \cos{\left(\theta_{1} - \theta_{2} \right)} + g m_{1} \sin{\left(\theta_{1} \right)} + g m_{2} \sin{\left(\theta_{1} \right)}}{L_{1} \left(m_{1} + m_{2}\right)}, \\
