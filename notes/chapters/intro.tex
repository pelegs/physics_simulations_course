...
We can now plot the position of the mass vs. its momentum $p=m\dot{x}$ (\autoref{fig:harmonic_oscillator_phase_space}). This is called a \textbf{phase space} plot. MORE TEXT ON THE PHASE SPACE.
